    ...
    var RestaurantEngine = (function () {
        ...
        var Receipe = (function(){
          function Receipe(name, price, calories, quantity, timeToPrepare) {
              ...
              this.timeToPrepare = price;
          }

          Receipe.prototype.toString = function(){
            var result = '';
            var veganMark = function(){
              if (this.isVegan) {
                return '[VEGAN] ';
              }else {
                return '';
            ...
            result += veganMark() + '==' +  this.name + '== $' + this.price + '\n';
        ...
        var Drink = (function () {
            function Drink(name, price, calories, quantity, timeToPrepare, isCarbonated){
              ...
              Receipe.call(this, name, calories, quantity, timeToPrepare);
            ...
            Drink.prototype.toString = function(){
              ...
              result += 'Carbonated: ' + this.isCarbonated ? 'yes' : 'no';
        ...
        var Meal = (function () {
            ...
            Meal.constructor = Meal;
            Meal.prototype.toString = function () {
              return Receipe.prototype.toString.call(this);
            };
